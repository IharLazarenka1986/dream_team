...
import { salesData } from "./allProductsAndSalesData.js";
...
const AllSales = () => {
  ...
  let filteredProducts = salesData.filter((item) => {
  ...
  if (sortBy === "price: low-high") {
    ...
    filteredProducts = [...filteredProducts].reverse(); // пример
  }

  return (
    <div className={cn.categoriesWrapper}>
      <NavButtons firstBtn="Main page" secondBtn="All sales" />
      <h2 className={cn.titleCategories}>Discounted items</h2>
